...
export class Service {
  ...
  static UpdateMessage(req: Servicev1Conversation.UpdateMessageRequest, entityNotifier?: fm.NotifyStreamEntityArrival<Servicev1Conversation.Message>, initReq?: fm.InitReq): Promise<void> {
    return fm.fetchStreamingRequest<Servicev1Conversation.UpdateMessageRequest, Servicev1Conversation.Message>(`/v1/conversations/${req["conversationId"]}/messages/${req["id"]}`, entityNotifier, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
