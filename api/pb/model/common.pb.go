...
type GenrateTokenRequest struct {
	...
	MagicCode string `protobuf:"bytes,1,opt,name=magicCode,proto3" json:"magicCode,omitempty"`
	Qrcode    string `protobuf:"bytes,2,opt,name=qrcode,proto3" json:"qrcode,omitempty"`
}

func (x *GenrateTokenRequest) Reset() {
	*x = GenrateTokenRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GenrateTokenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GenrateTokenRequest) ProtoMessage() {}

func (x *GenrateTokenRequest) ProtoReflect() protoreflect.Message {
	mi := &file_model_common_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GenrateTokenRequest.ProtoReflect.Descriptor instead.
func (*GenrateTokenRequest) Descriptor() ([]byte, []int) {
	return file_model_common_proto_rawDescGZIP(), []int{2}
}

func (x *GenrateTokenRequest) GetMagicCode() string {
	if x != nil {
		return x.MagicCode
	}
	return ""
...
func (x *GenrateTokenRequest) GetQrcode() string {
	if x != nil {
		return x.Qrcode
	}
	return ""
...
func (x *OAuthProvider) Reset() {
	*x = OAuthProvider{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_common_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OAuthProvider) Descriptor() ([]byte, []int) {
	return file_model_common_proto_rawDescGZIP(), []int{7}
}
...
func (x *OAuthURLResponse) Reset() {
	*x = OAuthURLResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_common_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OAuthURLResponse) Descriptor() ([]byte, []int) {
	return file_model_common_proto_rawDescGZIP(), []int{8}
}

func (x *OAuthURLResponse) GetProviders() []*OAuthProvider {
	if x != nil {
		return x.Providers
	}
	return nil
...
func (x *GenerateWechatQRCodeResponse) Reset() {
	*x = GenerateWechatQRCodeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_model_common_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GenerateWechatQRCodeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GenerateWechatQRCodeResponse) ProtoMessage() {}

func (x *GenerateWechatQRCodeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_model_common_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GenerateWechatQRCodeResponse.ProtoReflect.Descriptor instead.
func (*GenerateWechatQRCodeResponse) Descriptor() ([]byte, []int) {
	return file_model_common_proto_rawDescGZIP(), []int{9}
}

func (x *GenerateWechatQRCodeResponse) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *GenerateWechatQRCodeResponse) GetQrcode() string {
	if x != nil {
		return x.Qrcode
	}
	return ""
...
var file_model_common_proto_rawDesc = []byte{
	...
	,
	...
	0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72,
	0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x22,
	0x31, 0x0a, 0x16, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x41, 0x70, 0x69, 0x4b, 0x65,
	...
	0x65, 0x79, 0x22, 0x40, 0x0a, 0x14, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x43, 0x61, 0x6c, 0x6c, 0x62,
	...
	,
	...
	0x63, 0x6f, 0x64, 0x65, 0x2a, 0x20, 0x0a, 0x0b, 0x4e, 0x75, 0x6d, 0x65, 0x72, 0x69, 0x63, 0x45,
	0x6e, 0x75, 0x6d, 0x12, 0x08, 0x0a, 0x04, 0x5a, 0x45, 0x52, 0x4f, 0x10, 0x00, 0x12, 0x07, 0x0a,
	0x03, 0x4f, 0x4e, 0x45, 0x10, 0x01, 0x42, 0x78, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x76, 0x31, 0x42, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x50,
...
var file_model_common_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_model_common_proto_goTypes = []interface{}{
	...
	(*GenrateTokenRequest)(nil),          // 3: servicev1.GenrateTokenRequest
	(*GenrateTokenResponse)(nil),         // 4: servicev1.GenrateTokenResponse
	(*GenerateApiKeyResponse)(nil),       // 5: servicev1.GenerateApiKeyResponse
	(*OAuthCallbackRequest)(nil),         // 6: servicev1.OAuthCallbackRequest
	(*OAuthURLRequest)(nil),              // 7: servicev1.OAuthURLRequest
	(*OAuthProvider)(nil),                // 8: servicev1.OAuthProvider
...
func file_model_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_model_common_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GenrateTokenRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_model_common_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_model_common_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_model_common_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GenerateWechatQRCodeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
